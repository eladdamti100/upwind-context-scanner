...
var csvHeader = []string{
	...
	"storage_exposure", "asset_criticality", "customer_vertical", "label", "is_true_secret",
}
...
func WriteCSV(path string, recs []fsbuilder.FindingRecord) error {
	...
	for _, r := range recs {
		...
		row := []string{
			...
			fe.StorageExposure, fe.AssetCriticality, fe.CustomerVertical, fe.Label, b(fe.Label == fsbuilder.LabelTrueSecret),
		}
